...
#raWebApiKey=
libraryPath="/roms"
consoles="atari5200,vectrex,intellivision,wswan,wswanc,atari7800,colecovision,sg1000,virtualboy,pokemini,gamegear,gb,gbc,gba,nes,snes,mastersystem,sega32x,psx,ps2"
